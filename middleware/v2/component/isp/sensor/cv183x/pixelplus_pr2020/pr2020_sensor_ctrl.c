...
int pr2020_sys_init(VI_PIPE ViPipe)
{
	...
	//PR2K_RST
	if (PR2020_GPIO_SetValue(CVI_GPIOC_31, 1) != 0) {
...
CVI_VOID *pr2020_device_auto_detect(void *parg)
{
	VI_PIPE ViPipe = *(VI_PIPE *)parg;
...
#if PR2020_AUTO_DETECT
	if (pthread_create(&g_pr2020_thid, NULL, pr2020_device_auto_detect, (void *)&ViPipe) != 0) {
