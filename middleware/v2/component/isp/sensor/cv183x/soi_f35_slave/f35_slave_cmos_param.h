#ifndef __F35_SLAVE_CMOS_PARAM_H_
#define __F35_SLAVE_CMOS_PARAM_H_
...
static const F35_SLAVE_MODE_S g_astF35_Slave_mode[F35_SLAVE_MODE_NUM] = {
	[F35_SLAVE_MODE_1080P30] = {
		.name = "1080p30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1920,
...
ISP_CMOS_NOISE_CALIBRATION_S g_stIspNoiseCalibration = {.CalibrationCoef = {
	{	//iso  100
...
static ISP_CMOS_BLACK_LEVEL_S g_stIspBlcCalibratio = {
	...
	.blcAttr = {
		...
		.stAuto = {
			{68, 66, 67, 65, 69, 135, 271, 255, /*8*/255, 255, 255, 255, 255, 256, 255, 256},
			{68, 66, 67, 65, 69, 135, 255, 255, /*8*/255, 255, 255, 255, 255, 256, 255, 256},
			{68, 66, 67, 65, 69, 128, 271, 271, /*8*/271, 255, 255, 256, 256, 256, 256, 256},
			{68, 66, 67, 65, 69, 128, 255, 271, /*8*/271, 255, 255, 256, 255, 256, 256, 256},
...
struct combo_dev_attr_s f35_slave_rx_attr = {
...
#endif /* __F35_SLAVE_CMOS_PARAM_H_ */
