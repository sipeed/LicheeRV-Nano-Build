#ifndef __OS08A20_SLAVE_CMOS_PARAM_H_
#define __OS08A20_SLAVE_CMOS_PARAM_H_
...
static const OS08A20_SLAVE_MODE_S g_astOs08a20_Slave_mode[OS08A20_SLAVE_MODE_NUM] = {
	[OS08A20_SLAVE_MODE_2592X1944P30] = {
		.name = "2592x1944p30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 2592,
	...
	[OS08A20_SLAVE_MODE_2592X1944P30_WDR] = {
	...
	[OS08A20_SLAVE_MODE_2560X1440P30] = {
		...
		.f32MaxFps = 30,
		.f32MinFps = 2.15, /* 0x1254 * 30 / 0xFFFF */
		.u32HtsDef = 0x818,
		.u32VtsDef = 0x1254,
		.stExp[0] = {
			.u16Min = 8,
	...
	[OS08A20_SLAVE_MODE_2560X1440P30_WDR] = {
		...
		/*
		 * According to formula, it shall be 0x35d in 30fps at most.
		 * However, with larger L2S the range of Lexp becomes smaller.
		 */
		.u32L2S_MAX = 0x13D,
	},
};
...
struct combo_dev_attr_s os08a20_slave_rx_attr = {
	.input_mode = INPUT_MODE_MIPI,
	.mac_clk = RX_MAC_CLK_600M,
	.mipi_attr = {
		.raw_data_type = RAW_DATA_10BIT,
		.lane_id = {1, 2, 3, 0, 4},
		.wdr_mode = CVI_MIPI_WDR_MODE_DT,
		.data_type = {0x2b, 0x19},
	},
	.mclk = {
		.cam = 0,
...
#endif /* __OS08A20_SLAVE_CMOS_PARAM_H_ */
