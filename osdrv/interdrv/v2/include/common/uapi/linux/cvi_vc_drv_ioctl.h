...
#define CVI_VC_VENC_ENABLE_SVC				_IO(CVI_VC_DRV_IOCTL_MAGIC, 78)
#define CVI_VC_VENC_SET_SVC_PARAM			_IO(CVI_VC_DRV_IOCTL_MAGIC, 79)
#define CVI_VC_VENC_GET_SVC_PARAM			_IO(CVI_VC_DRV_IOCTL_MAGIC, 80)
