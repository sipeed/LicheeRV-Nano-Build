...
void gc4653_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	CVI_U8 value = 0;
	...
	gc4653_write_register(ViPipe, 0x0101, value);
}
...
static void gc4653_linear_1440p30_init(VI_PIPE ViPipe)
{
	...
	/*//mast mode
	gc4653_write_register(ViPipe, 0x027f, 0x09);
	gc4653_write_register(ViPipe, 0x0280, 0x40);
	gc4653_write_register(ViPipe, 0x0106, 0x38);
	*/
