...
void n5_init(VI_PIPE ViPipe)
{
	...
	// set device config
	n5_set_chnmode(ViPipe, 0, N5_MODE_1080P_30P);
	n5_set_chnmode(ViPipe, 1, N5_MODE_1080P_30P);
	n5_set_portmode(ViPipe, 0, N5_OUTMODE_1MUX_FHD, 0/*is_bt601*/);
	n5_set_portmode(ViPipe, 1, N5_OUTMODE_1MUX_FHD, 0/*is_bt601*/);
