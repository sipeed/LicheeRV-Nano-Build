...
static void f23_linear_1080p30_init(VI_PIPE ViPipe)
{
	...
	f23_write_register(ViPipe, 0x12, 0x40);
	f23_write_register(ViPipe, 0x48, 0x85);
	f23_write_register(ViPipe, 0x48, 0x05);
	f23_write_register(ViPipe, 0x0E, 0x11);
	f23_write_register(ViPipe, 0x0F, 0x14);
	f23_write_register(ViPipe, 0x10, 0x40);
	f23_write_register(ViPipe, 0x11, 0x80);
	f23_write_register(ViPipe, 0x0D, 0x50);
	...
	f23_write_register(ViPipe, 0x23, 0x04);
	...
	f23_write_register(ViPipe, 0x6C, 0x50);
	f23_write_register(ViPipe, 0x68, 0x00);
	f23_write_register(ViPipe, 0x6E, 0x2C);
	f23_write_register(ViPipe, 0x70, 0xDC);
	f23_write_register(ViPipe, 0x71, 0xD3);
	f23_write_register(ViPipe, 0x72, 0xD4);
	f23_write_register(ViPipe, 0x73, 0x58);
	f23_write_register(ViPipe, 0x74, 0x02);
	f23_write_register(ViPipe, 0x78, 0x8B);
	...
	f23_write_register(ViPipe, 0x0C, 0x40);
	...
	printf("ViPipe:%d,===F23 1080P 30fps 10bit LINE Init OK!===\n", ViPipe);
}
