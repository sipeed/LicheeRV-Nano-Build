...
struct combo_dev_attr_s imx327_mipi_attr = {
	...
	.mipi_attr = {
		...
		.lane_id = {2, 3, 1, 4, 0},
		.pn_swap = {1, 1, 1, 1, 1},
		.hdr_mode = CVI_MIPI_HDR_MODE_DOL,
	},
	.mclk = {
		.cam = 0,
...
struct combo_dev_attr_s imx327_sublvds_attr = {
	.input_mode = INPUT_MODE_SUBLVDS,
	.mac_clk = RX_MAC_CLK_200M,
	.lvds_attr = {
		.hdr_mode = CVI_HDR_MODE_DOL_2F,
