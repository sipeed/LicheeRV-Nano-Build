...
#include "imx290_2l_cmos_param.h"
#include <linux/cvi_vip_snsr.h>

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define IMX290_ID 290
#define SENSOR_IMX290_WIDTH 1280
#define SENSOR_IMX290_HEIGHT 720
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastImx290_2l[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define IMX290_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastImx290_2l[dev])
#define IMX290_SENSOR_SET_CTX(dev, pstCtx)   (g_pastImx290_2l[dev] = pstCtx)
#define IMX290_SENSOR_RESET_CTX(dev)         (g_pastImx290_2l[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunImx290_2l_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16Imx290_2l_GainMode[VI_MAX_PIPE_NUM] = {0};

IMX290_2L_STATE_S g_astImx290_2l_State[VI_MAX_PIPE_NUM] = {{0} };
...
#define IMX290_FULL_LINES_MAX_2TO1_WDR  (0x3FFFF)    // considering the YOUT_SIZE and bad frame
#define IMX290_VMAX_720P30_LINEAR	750

/*****Imx290 Register Address*****/
#define IMX290_HOLD_ADDR		0x3001
#define IMX290_SHS1_ADDR		0x3020
#define IMX290_SHS2_ADDR		0x3024
#define IMX290_GAIN_ADDR		0x3014
#define IMX290_GAIN1_ADDR		0x30F2
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	case WDR_MODE_NONE:   /*linear mode*/
		pstAeSnsDft->f32Fps = g_astImx290_2l_mode[IMX290_2L_MODE_720P30].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astImx290_2l_mode[IMX290_2L_MODE_720P30].f32MinFps;
	...
	case WDR_MODE_2To1_LINE:
		pstAeSnsDft->f32Fps = g_astImx290_2l_mode[IMX290_2L_MODE_720P15_WDR].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astImx290_2l_mode[IMX290_2L_MODE_720P15_WDR].f32MinFps;
...
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	CVI_U32 u32VMAX = IMX290_VMAX_720P30_LINEAR;
	...
	u32Vts = g_astImx290_2l_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astImx290_2l_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astImx290_2l_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case IMX290_2L_MODE_720P15_WDR:
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		 ...
		 * 2n + 5
		 * RHS1 <= FSC - BRL*2 -21
		 * (2 * VMAX_IMX290_1080P30_WDR - 2 * gu32BRL - 21) -
		 * (((2 * VMAX_IMX290_1080P30_WDR - 2 * 735 - 21) - 5) %2)
		 */

		g_astImx290_2l_State[ViPipe].u32RHS1_MAX = (u32VMAX - g_astImx290_2l_State[ViPipe].u32BRL) * 2 - 21;
	} else {
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		g_astImx290_2l_State[ViPipe].u32RHS1 = u32RHS1;
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u32HCG = g_astImx290_2l_State[ViPipe].u8Hcg;
	CVI_U32 u16Mode = g_au16Imx290_2l_GainMode[ViPipe];
	CVI_U32 u32Tmp;
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		 ...
		 *  RHS1 <= FSC - BRL * 2 - 21
		 *
		 *  a. short exposure time = RHS1 - (SHS1 + 1) <= RHS1 - 3
		 *  long exposure time = FSC - (SHS2 + 1) <= FSC - (RHS1 + 3)
		 *  ExposureShort + ExposureLong <= FSC - 6
		 *  b. short exposure time <= (FSC - 6) / (ratio + 1)
		 *  c. short exposure time <= (FSC - 6 - SEF) / ratio
		 *  max short exposure time = min(a,b,c)
		 */
		...
		u32IntTimeMaxTmp  = (u32IntTimeMaxTmp > (g_astImx290_2l_State[ViPipe].u32RHS1_MAX - 3)) ?
					(g_astImx290_2l_State[ViPipe].u32RHS1_MAX - 3) : u32IntTimeMaxTmp;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const IMX290_2L_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	IMX290_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astImx290_2l_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == IMX290_2L_MODE_720P15_WDR)
			pstSnsState->u8ImgMode = IMX290_2L_MODE_720P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astImx290_2l_mode[pstSnsState->u8ImgMode].u32VtsDef;
		g_astImx290_2l_State[ViPipe].u8Hcg = 0x2;
		syslog(LOG_INFO, "linear mode\n");
		break;

	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == IMX290_2L_MODE_720P30)
			pstSnsState->u8ImgMode = IMX290_2L_MODE_720P15_WDR;
		pstSnsState->enWDRMode = WDR_MODE_2To1_LINE;
		/* shall be 2 since its 15FPS */
		g_astImx290_2l_State[ViPipe].u8Hcg    = 0x2;
		if (pstSnsState->u8ImgMode == IMX290_2L_MODE_720P15_WDR) {
			pstSnsState->u32FLStd = g_astImx290_2l_mode[pstSnsState->u8ImgMode].u32VtsDef * 2;
			g_astImx290_2l_State[ViPipe].u32BRL  = g_astImx290_2l_mode[pstSnsState->u8ImgMode].u16BRL;
			syslog(LOG_INFO, "2to1 line WDR 720p mode(30fps->15fps)\n");
		}
		break;
	default:
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunImx290_2l_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = imx290_2l_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = imx290_2l_addr_byte;
			pstI2c_data[i].u32DataByteNum = imx290_2l_data_byte;
		}
		...
		case WDR_MODE_2To1_LINE:
			//Linear Mode Regs
			pstI2c_data[DOL2_HOLD].u32RegAddr = IMX290_HOLD_ADDR;
			pstI2c_data[DOL2_HOLD].u32Data = 1;
			pstI2c_data[DOL2_SHS1_0].u32RegAddr = IMX290_SHS1_ADDR;
			pstI2c_data[DOL2_SHS1_1].u32RegAddr = IMX290_SHS1_ADDR + 1;
			pstI2c_data[DOL2_SHS1_2].u32RegAddr = IMX290_SHS1_ADDR + 2;

			pstI2c_data[DOL2_GAIN].u32RegAddr = IMX290_GAIN_ADDR;  //gain
			pstI2c_data[DOL2_HCG].u32RegAddr = IMX290_HCG_ADDR;
			pstI2c_data[DOL2_HCG].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_GAIN1].u32RegAddr = IMX290_GAIN1_ADDR;  //gain
			pstI2c_data[DOL2_RHS1_0].u32RegAddr = IMX290_RHS1_ADDR;
			pstI2c_data[DOL2_RHS1_0].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_RHS1_1].u32RegAddr = IMX290_RHS1_ADDR + 1;
			pstI2c_data[DOL2_RHS1_1].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_RHS1_2].u32RegAddr = IMX290_RHS1_ADDR + 2;
			pstI2c_data[DOL2_RHS1_2].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_SHS2_0].u32RegAddr = IMX290_SHS2_ADDR;
			pstI2c_data[DOL2_SHS2_1].u32RegAddr = IMX290_SHS2_ADDR + 1;
			pstI2c_data[DOL2_SHS2_2].u32RegAddr = IMX290_SHS2_ADDR + 2;
			pstI2c_data[DOL2_VMAX_0].u32RegAddr = IMX290_VMAX_ADDR;
			pstI2c_data[DOL2_VMAX_0].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_VMAX_1].u32RegAddr = IMX290_VMAX_ADDR + 1;
			pstI2c_data[DOL2_VMAX_1].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_VMAX_2].u32RegAddr = IMX290_VMAX_ADDR + 2;
			pstI2c_data[DOL2_VMAX_2].u8DelayFrmNum = 1;

			pstI2c_data[DOL2_REL].u32RegAddr = IMX290_HOLD_ADDR;
			pstI2c_data[DOL2_REL].u32Data = 0;
			break;
		default:
			pstI2c_data[LINEAR_HOLD].u32RegAddr = IMX290_HOLD_ADDR;
			pstI2c_data[LINEAR_HOLD].u32Data = 1;
			pstI2c_data[LINEAR_SHS1_0].u32RegAddr = IMX290_SHS1_ADDR;
			pstI2c_data[LINEAR_SHS1_1].u32RegAddr = IMX290_SHS1_ADDR + 1;
			pstI2c_data[LINEAR_SHS1_2].u32RegAddr = IMX290_SHS1_ADDR + 2;
			pstI2c_data[LINEAR_GAIN].u32RegAddr = IMX290_GAIN_ADDR;  //gain
			pstI2c_data[LINEAR_HCG].u32RegAddr = IMX290_HCG_ADDR;
			pstI2c_data[LINEAR_VMAX_0].u32RegAddr = IMX290_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_1].u32RegAddr = IMX290_VMAX_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_2].u32RegAddr = IMX290_VMAX_ADDR + 2;
			pstI2c_data[LINEAR_REL].u32RegAddr = IMX290_HOLD_ADDR;
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (IMX290_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = IMX290_2L_MODE_720P30;
			} else {
			...
			if (IMX290_RES_IS_720P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = IMX290_2L_MODE_720P15_WDR;
				g_astImx290_2l_State[ViPipe].u32BRL = 735;
			} else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->u8ImgMode = IMX290_2L_MODE_720P30;
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstSnsState->u32FLStd  = IMX290_VMAX_720P30_LINEAR;
	pstSnsState->au32FL[0] = IMX290_VMAX_720P30_LINEAR;
	pstSnsState->au32FL[1] = IMX290_VMAX_720P30_LINEAR;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &imx290_2l_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astImx290_2l_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astImx290_2l_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE)
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &imx290_2l_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = imx290_2l_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = imx290_2l_exit;
...
static CVI_S32 imx290_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunImx290_2l_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, IMX290_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, IMX290_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, IMX290_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16Imx290_2l_GainMode[ViPipe] = pstInitAttr->enGainMode;

	return CVI_SUCCESS;
}

ISP_SNS_OBJ_S stSnsImx290_2l_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = imx290_2l_standby,
	.pfnRestart             = imx290_2l_restart,
	.pfnMirrorFlip          = CVI_NULL,
	.pfnWriteReg            = imx290_2l_write_register,
	.pfnReadReg             = imx290_2l_read_register,
