...
static void imx335_linear_5M60_init(VI_PIPE ViPipe);
static void imx335_linear_4M60_init(VI_PIPE ViPipe);
static void imx335_linear_2M60_init(VI_PIPE ViPipe);
static void imx335_wdr_2M30_2to1_init(VI_PIPE ViPipe);
...
void imx335_init(VI_PIPE ViPipe)
{
	...
	if (enWDRMode == WDR_MODE_2To1_LINE) {
		...
		else if (u8ImgMode == IMX335_MODE_2M30_WDR)
			imx335_wdr_2M30_2to1_init(ViPipe);
		else{
		}
	} else {
		...
		else if (u8ImgMode == IMX335_MODE_5M60)
			imx335_linear_5M60_init(ViPipe);
		else if (u8ImgMode == IMX335_MODE_4M60)
			imx335_linear_4M60_init(ViPipe);
		else if (u8ImgMode == IMX335_MODE_2M60)
			imx335_linear_2M60_init(ViPipe);
		else {
		}
	}
...
static void imx335_linear_5M60_init(VI_PIPE ViPipe)
{
	...
	delay_ms(20);
	imx335_write_register(ViPipe, 0x3002, 0x00); /* master mode start */
	CVI_TRACE_SNS(CVI_DBG_INFO, "ViPipe:%d,===IMX335 5M 60fps 10bit LINE Init OK!===\n", ViPipe);
}
...
static void imx335_linear_4M60_init(VI_PIPE ViPipe)
{
	...
	imx335_write_register(ViPipe, 0x3035, 0x01);  //
	imx335_write_register(ViPipe, 0x3050, 0x00);  // ADBIT[0]
	imx335_write_register(ViPipe, 0x3056, 0xBC);  // Y_OUT_SIZE[12:0]
	imx335_write_register(ViPipe, 0x3057, 0x05);  //
	imx335_write_register(ViPipe, 0x3074, 0xA0);  // AREA3_ST_ADR_1[12:0]
	imx335_write_register(ViPipe, 0x3075, 0x02);  //
	imx335_write_register(ViPipe, 0x3076, 0x78);  // AREA3_WIDTH_1[12:0]
	imx335_write_register(ViPipe, 0x3077, 0x0B);  //
	imx335_write_register(ViPipe, 0x30C6, 0x12);  // BLACK_OFSET_ADR[12:0]
	imx335_write_register(ViPipe, 0x30CE, 0x64);  // UNRD_LINE_MAX[12:0]
	imx335_write_register(ViPipe, 0x30D8, 0xE8);  // UNREAD_ED_ADR[12:0]
	imx335_write_register(ViPipe, 0x30D9, 0x0E);  //
	imx335_write_register(ViPipe, 0x315A, 0x02);  // INCKSEL2[1:0]
	imx335_write_register(ViPipe, 0x316A, 0x7E);  // INCKSEL4[1:0]
	imx335_write_register(ViPipe, 0x319D, 0x00);  // MDBIT
	...
	delay_ms(20);
	imx335_write_register(ViPipe, 0x3002, 0x00); /* master mode start */
	CVI_TRACE_SNS(CVI_DBG_INFO, "ViPipe:%d,===IMX335 4M 60fps 10bit LINE Init OK!===\n", ViPipe);
}
...
static void imx335_linear_2M60_init(VI_PIPE ViPipe)
{
	...
	imx335_write_register(ViPipe, 0x300D, 0x40);  // CPWAIT_TIME[7:0]
	imx335_write_register(ViPipe, 0x3018, 0x04);  // WINMODE[3:0]
	imx335_write_register(ViPipe, 0x302C, 0x80);  // HTRIMMING_START[11:0]
	imx335_write_register(ViPipe, 0x302D, 0x01);  //
	imx335_write_register(ViPipe, 0x302E, 0x98);  // HNUM[11:0]
	imx335_write_register(ViPipe, 0x302F, 0x07);  //
	imx335_write_register(ViPipe, 0x3034, 0x13);  // HMAX[15:0]
	imx335_write_register(ViPipe, 0x3035, 0x01);  //
	imx335_write_register(ViPipe, 0x3050, 0x00);  // ADBIT[0]
	imx335_write_register(ViPipe, 0x3056, 0x4C);  // Y_OUT_SIZE[12:0]
	imx335_write_register(ViPipe, 0x3057, 0x04);  //
	imx335_write_register(ViPipe, 0x3074, 0x10);  // AREA3_ST_ADR_1[12:0]
	imx335_write_register(ViPipe, 0x3075, 0x04);  //
	imx335_write_register(ViPipe, 0x3076, 0x98);  // AREA3_WIDTH_1[12:0]
	imx335_write_register(ViPipe, 0x3077, 0x08);  //
	imx335_write_register(ViPipe, 0x30C6, 0x12);  // BLACK_OFSET_ADR[12:0]
	imx335_write_register(ViPipe, 0x30CE, 0x64);  // UNRD_LINE_MAX[12:0]
	imx335_write_register(ViPipe, 0x30D8, 0x78);  // UNREAD_ED_ADR[12:0]
	...
	delay_ms(20);
	imx335_write_register(ViPipe, 0x3002, 0x00); /* master mode start */
	CVI_TRACE_SNS(CVI_DBG_INFO, "ViPipe:%d,===IMX335 2M 60fps 10bit LINE Init OK!===\n", ViPipe);
}
...
static void imx335_wdr_2M30_2to1_init(VI_PIPE ViPipe)
{
	...
	delay_ms(20);
	imx335_write_register(ViPipe, 0x3002, 0x00); /* master mode start */
	CVI_TRACE_SNS(CVI_DBG_INFO, "ViPipe:%d,===IMX335 2M 30fps 10bit WDR2TO1 Init OK!===\n", ViPipe);
}
