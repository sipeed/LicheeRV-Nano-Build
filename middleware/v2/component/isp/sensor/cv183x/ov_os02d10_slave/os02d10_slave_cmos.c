...
#include "os02d10_slave_cmos_param.h"
#include <linux/cvi_vip_snsr.h>

#define DIV_0_TO_1(a)   ((0 == (a)) ? 1 : (a))
#define DIV_0_TO_1_FLOAT(a) ((((a) < 1E-10) && ((a) > -1E-10)) ? 1 : (a))
#define OS02D10_SLAVE_ID 0x2309
#define OS02D10_SLAVE_I2C_ADDR_1 0x3C
#define OS02D10_SLAVE_I2C_ADDR_2 0x3C
#define OS02D10_SLAVE_I2C_ADDR_IS_VALID(addr) ((addr) == OS02D10_SLAVE_I2C_ADDR_1 || \
	(addr) == OS02D10_SLAVE_I2C_ADDR_2)
#define OS02D10_SLAVE_PCLK (84)
/****************************************************************************
 * global variables                                                            *
 ****************************************************************************/

ISP_SNS_STATE_S *g_pastOs02d10_Slave[VI_MAX_PIPE_NUM] = {CVI_NULL};

#define OS02D10_SLAVE_SENSOR_GET_CTX(dev, pstCtx)   (pstCtx = g_pastOs02d10_Slave[dev])
#define OS02D10_SLAVE_SENSOR_SET_CTX(dev, pstCtx)   (g_pastOs02d10_Slave[dev] = pstCtx)
#define OS02D10_SLAVE_SENSOR_RESET_CTX(dev)         (g_pastOs02d10_Slave[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunOs02d10_Slave_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16Os02d10_Slave_GainMode[VI_MAX_PIPE_NUM] = {0};
CVI_U16 g_au16Os02d10_Slave_UseHwSync[VI_MAX_PIPE_NUM] = {0};

OS02D10_SLAVE_STATE_S g_astOs02d10_Slave_State[VI_MAX_PIPE_NUM] = {{0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeOs02d10_Slave_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
/*****Os02d10_Slave Lines Range*****/
#define OS02D10_SLAVE_FULL_LINES_MAX  (0x0FFF)

/*****Os02d10 Register Address*****/
#define OS02D10_SLAVE_PAGE_SWITCH_ADDR		0xFD
#define OS02D10_SLAVE_EXP0_ADDR				0x03
#define OS02D10_SLAVE_EXP_EN_ADDR			0x01
#define OS02D10_SLAVE_AGAIN0_ADDR			0x24
#define OS02D10_SLAVE_DGAIN0_ADDR			0x39
#define OS02D10_SLAVE_HB_ADDR				0x09
#define OS02D10_SLAVE_TABLE_END				0xffff

#define OS02D10_FLIP_MIRROR_ADDR		0x3F
#define OS02D10_START_X_ADDR			0xA5
#define OS02D10_START_Y_ADDR			0xA1

#define OS02D10_SLAVE_RES_IS_1080P(w, h)      ((w) <= 1920 && (h) <= 1080)

static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	const OS02D10_SLAVE_MODE_S *pstMode;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	CMOS_CHECK_POINTER(pstAeSnsDft);
	OS02D10_SLAVE_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);

	pstMode = &g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode];
#if 0
	memset(&pstAeSnsDft->stAERouteAttr, 0, sizeof(ISP_AE_ROUTE_S));
#endif
	pstAeSnsDft->u32FullLinesStd = pstSnsState->u32FLStd;
	pstAeSnsDft->u32FlickerFreq = 50 * 256;
	pstAeSnsDft->u32FullLinesMax = OS02D10_SLAVE_FULL_LINES_MAX;
...
static CVI_S32 cmos_fps_set(VI_PIPE ViPipe, CVI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	u32Hts = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].u32HtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].f32MinFps;
	...
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
		...
		u32HBMAX = (u32HBMAX > OS02D10_SLAVE_FULL_LINES_MAX) ? OS02D10_SLAVE_FULL_LINES_MAX : u32HBMAX;
	 ...
	 */
	u32Hts = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].u32HtsDef * f32MaxFps / f32Fps;
	f32LineTime = (CVI_FLOAT)u32Hts / OS02D10_SLAVE_PCLK * 2;
...
{
	const OS02D10_SLAVE_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		pstSnsState->u8ImgMode = OS02D10_SLAVE_MODE_1920X1080P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunOs02d10_Slave_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = os02d10_slave_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = os02d10_slave_addr_byte;
			pstI2c_data[i].u32DataByteNum = os02d10_slave_data_byte;
		}

		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_NONE:
			// switch page 1
			pstI2c_data[LINEAR_PAGE_1].u32RegAddr = OS02D10_SLAVE_PAGE_SWITCH_ADDR;
			pstI2c_data[LINEAR_PAGE_1].u32Data = 0x01;

			pstI2c_data[LINEAR_EXP_0].u32RegAddr = OS02D10_SLAVE_EXP0_ADDR;
			pstI2c_data[LINEAR_EXP_1].u32RegAddr = OS02D10_SLAVE_EXP0_ADDR + 1;

			pstI2c_data[LINEAR_AGAIN_0].u32RegAddr = OS02D10_SLAVE_AGAIN0_ADDR;
			pstI2c_data[LINEAR_DGAIN_0].u32RegAddr = OS02D10_SLAVE_DGAIN0_ADDR;

			pstI2c_data[LINEAR_FLIP_MIRROR].u32RegAddr = 0x3f;

			pstI2c_data[LINEAR_HB_H].u32RegAddr = OS02D10_SLAVE_HB_ADDR;
			pstI2c_data[LINEAR_HB_L].u32RegAddr = OS02D10_SLAVE_HB_ADDR + 1;

			pstI2c_data[LINEAR_EXP_EN].u32RegAddr = OS02D10_SLAVE_EXP_EN_ADDR;
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (OS02D10_SLAVE_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = OS02D10_SLAVE_MODE_1920X1080P30;
			} else {
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeOs02d10_Slave_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		...
		g_aeOs02d10_Slave_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_VOID sensor_global_init(VI_PIPE ViPipe)
{
	...
	pstSnsState->enWDRMode = WDR_MODE_NONE;
	pstSnsState->u32FLStd  = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsState->au32FL[0] = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsState->au32FL[1] = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].u32VtsDef;
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &os02d10_slave_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astOs02d10_Slave_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE)
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &os02d10_slave_rx_attr;
	int i;
...
static CVI_S32 cmos_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
	...
	pstSensorExpFunc->pfn_cmos_sensor_init = os02d10_slave_init;
	pstSensorExpFunc->pfn_cmos_sensor_exit = os02d10_slave_exit;
...
{
	if (OS02D10_SLAVE_I2C_ADDR_IS_VALID(s32I2cAddr))
		os02d10_slave_i2c_addr = s32I2cAddr;
}

static CVI_S32 os02d10_slave_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunOs02d10_Slave_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_ctx_init(VI_PIPE ViPipe)
{
	...
	OS02D10_SLAVE_SENSOR_GET_CTX(ViPipe, pastSnsStateCtx);
	...
	OS02D10_SLAVE_SENSOR_SET_CTX(ViPipe, pastSnsStateCtx);
...
static CVI_VOID sensor_ctx_exit(VI_PIPE ViPipe)
{
	...
	OS02D10_SLAVE_SENSOR_RESET_CTX(ViPipe);
}
...
static CVI_S32 sensor_register_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	stSnsAttrInfo.eSensorId = OS02D10_SLAVE_ID;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, OS02D10_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, OS02D10_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
		CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
		return s32Ret;
	}

	s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, OS02D10_SLAVE_ID);
	if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16Os02d10_Slave_GainMode[ViPipe] = pstInitAttr->enGainMode;
	g_au16Os02d10_Slave_UseHwSync[ViPipe] = pstInitAttr->u16UseHwSync;

	return CVI_SUCCESS;
}
static CVI_S32 sensor_probe(VI_PIPE ViPipe)
{
	return os02d10_slave_probe(ViPipe);
}

ISP_SNS_OBJ_S stSnsOs02d10_Slave_Obj = {
	.pfnRegisterCallback    = sensor_register_callback,
	.pfnUnRegisterCallback  = sensor_unregister_callback,
	.pfnStandby             = os02d10_slave_standby,
	.pfnRestart             = os02d10_slave_restart,
	.pfnMirrorFlip          = sensor_mirror_flip,
	.pfnWriteReg            = os02d10_slave_write_register,
	.pfnReadReg             = os02d10_slave_read_register,
	.pfnSetBusInfo          = os02d10_slave_set_bus_info,
