#ifndef __OS02D10_CMOS_PARAM_H_
#define __OS02D10_CMOS_PARAM_H_
...
static const OS02D10_MODE_S g_astOs02d10_mode[OS02D10_MODE_NUM] = {
	[OS02D10_MODE_1920X1080P30] = {
		.name = "1920x1080p30",
		.astImg[0] = {
			.stSnsSize = {
				.u32Width = 1928,
...
struct combo_dev_attr_s os02d10_rx_attr = {
