...
#define PR2100_RES_IS_2M_2CH(w, h)      ((w) <= 3844 && (h) <= 1124)
#define PR2100_RES_IS_2M_4CH(w, h)      ((w) <= 7688 && (h) <= 1124)
...
static CVI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		...
		} else if (PR2100_RES_IS_2M_2CH(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
			u8SensorImageMode = PR2100_MODE_1080P_2CH;
		} else if (PR2100_RES_IS_2M_4CH(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
